...
public class AdminService implements IAdminService {
	...
	public Map<String, Object> updateMerchantsStore_audit(MerchantsStore_audit merchantsStore_audit) {
		...
		if("通过".equals(applyState)){
			...
			List<MerchantsStore_audit> list = merchantsStoreDao_auditDao.findMerchantsStore_auditById(merchantsStore_audit);
			...
			merchantsStore.setTel(1831602228);
